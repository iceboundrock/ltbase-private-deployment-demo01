...
selected_auth_cors_allow_origins="$(bootstrap_env_append_csv_value_once "$(bootstrap_env_resolve_stack_value AUTH_CORS_ALLOW_ORIGINS "${STACK}" "*")" "https://${CONTROLPLANE_UI_DOMAIN}")"
selected_control_plane_cors_allow_origins_raw="$(bootstrap_env_resolve_stack_value CONTROL_PLANE_CORS_ALLOW_ORIGINS "${STACK}")"
selected_control_plane_cors_allow_origins="$(bootstrap_env_append_csv_value_once "${selected_control_plane_cors_allow_origins_raw}" "https://${CONTROLPLANE_UI_DOMAIN}")"
selected_control_plane_cors_origins="${selected_control_plane_cors_allow_origins}"
